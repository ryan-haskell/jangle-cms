module Supabase.Queries.FindProject exposing
    ( Input, new
    , Data
...
type alias Input =
    Supabase.Queries.FindProject.Input.Input {}
...
new input =
    ...
    , query = """
      ...
      """
    , variables = Supabase.Queries.FindProject.Input.toInternalValue input
    , decoder = decoder
    }
